            ...
            >
                ...
                >
                    ...
                    <p className="body color-color-light-light extra-margin ">
                        ...
                        &nbsp;has effectively legalized discrimination, and
                    ...
                    <p className="body color-color-light-light extra-margin ">
                        ...
                        is allowed to deny clients based on their convictions,
                        then so are we. We refuse to work with anyone who denies
                        the rights or diminishes the validity of any human
                        being.
                    </p>
                </div>
            </Section>
