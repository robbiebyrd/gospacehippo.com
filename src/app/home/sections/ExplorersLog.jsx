...
import "./ExplorersLog.scss";

const cn = classNames;

export default function ExplorersLog(props) {
    return (
        <Section
            id="ExplorersLog"
            ...
            <SectionLayout layout={"1-alt"}>
                ...
                &rsquo;
                        ...
                        <p className={cn(gcc("light", "light"), "")}>
                            The universe of Open Source Software is vast and wide, and without
                            the right flight plan, it&rsquo;s easy for a launch to quickly
                            become adrift. Our Hipponauts train year-round with new
                            technologies to keep their flight-readiness status at its apsis.
                        </p>
                    </SectionLayout>
                </Aside>
            </SectionLayout>
