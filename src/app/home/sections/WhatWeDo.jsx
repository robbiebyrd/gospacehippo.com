...
import {faBrainCircuit, faBrowser, faCubes, faMobile, faPalette, faStars,} from "@fortawesome/pro-solid-svg-icons";
    ...
    return (
        ...
        >
            <SectionLayout layout={1}>
                <h1 className={cn("no-margin", gcc("light", "light"))}>We do</h1>
                <h1
                    className={
                ...
                <ul className={"item-list col-1"}>
                    <li className={cn(gcc("light", "light"))}>
                        ...
                        >
                            <FontAwesomeIcon
                                style={{fontSize: ".75em", marginRight: "1em"}}
                                icon={faPalette}
                            />{" "}
                            Design & Branding
                        </h2>
